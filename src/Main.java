...
public class Main {
        public static void main(String[] args) throws IOException {
            BufferedReader reader1 = new BufferedReader(new FileReader("G:/DLSU/TERM 5/LBYCP2D/Module 0/src/Main.java"));
            BufferedReader reader2 = new BufferedReader(new FileReader("G:/DLSU/TERM 5/LBYCP2D/Module 0/Assets2/Diane_main.java"));
